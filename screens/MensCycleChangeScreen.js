...
import { storeMyStuff, getMyObjectStuff, getMyStringStuff } from "../database/CreateDatabase";
...
const MensCycleChangeScreen = (props) => {
  ...
  const storeLengths = async () => {
    if(mensLength===null){mensLength=oldmensLength}
    if(cyclusLength===null){cyclusLength=oldcyclusLength}
